...
const IconSound = ({ color = "white", content = "", language = "" }) => {
  ...
  const speak = () => {
    ...
    if (content && !speechSynthesis.speaking) {
  ...
  return (
    <svg  
      className="cursor-pointer transition-transform duration-300 ease-in-out hover:scale-110 hover:fill-blue-400"
      onClick={speak}
      height="20"
      viewBox="0 0 512 512"
      width="25"
